    ...
    <svg width="300" height="240" viewBox="0 0 300 240" aria-hidden="true">
      ...
      {dirt > 0 && (
        <g className="fz-dirt" style={{ opacity: dirt }}>
          <ellipse cx="85" cy="205" rx="18" ry="10" fill="#A56F42" /><ellipse cx="227" cy="207" rx="17" ry="9" fill="#8E5E36" />
          <ellipse cx="128" cy="212" rx="12" ry="7" fill="#8E5E36" /><ellipse cx="188" cy="214" rx="13" ry="7" fill="#A56F42" />
          <ellipse cx="110" cy="166" rx="20" ry="9" fill="#A56F42" /><ellipse cx="230" cy="150" rx="12" ry="8" fill="#8E5E36" />
          <circle cx="70" cy="120" r="7" fill="#A56F42" /><circle cx="160" cy="92" r="5" fill="#8E5E36" />
        </g>
      )}
      {/* Pelo despenteado (escova) */}
      {scruff > 0 && (
        <g className="fz-scruff" style={{ opacity: scruff }} fill="none" stroke={INK} strokeWidth="4" strokeLinecap="round">
          <path d="M96 72l-6-18M120 70l2-20M150 68l6-18M180 70l-2-20M210 74l8-16" />
          <path d="M98 72c6-6 10-6 14-2M152 68c6-6 10-6 14-2" stroke="#4A3B36" />
        </g>
      )}
      {/* Úbere */}
